  ...
  [311],
  {
    762(t, e, i) {
      ...
      function v(t, e, i) {
        ...
        l(s) && l(n)
          ? y(s, n)
          : Object.prototype.hasOwnProperty.call(e, t) || (e[t] = m(n));
      }
        ...
        if (t._sorted) {
          ...
          if (g) {
            if (
              ((n = Math.min(
                Z(h, d, u).lo,
                i ? s : Z(e, d, r.getPixelForValue(u)).lo,
              )),
              c)
            ) {
              const t = h
          ...
          if (p) {
            let t = Math.max(
              Z(h, r.axis, f, !0).hi + 1,
              i ? 0 : Z(e, d, r.getPixelForValue(f), !0).hi + 1,
            );
            if (c) {
      ...
      const ct = (t) => 0 === t || 1 === t,
        ...
        ft = {
          ...
          easeInElastic: (t) => (ct(t) ? t : dt(t, 0.075, 0.3)),
          ...
          easeInOutBounce: (t) =>
            t < 0.5
              ? 0.5 * ft.easeInBounce(2 * t)
              : 0.5 * ft.easeOutBounce(2 * t - 1) + 0.5,
        };
      function gt(t) {
      ...
      function mt(t) {
        return gt(t) ? t : new s.Q1(t).saturate(0.5).darken(0.1).hexString();
      }
      ...
      const vt = {
        ...
        logarithmic(t, e, i) {
          ...
          return [1, 2, 3, 5, 10, 15].includes(s) || e > 0.8 * i.length
            ? vt.numeric.call(this, t, e, i)
            : "";
        },
      };
      var Mt = { formatters: vt };
      ...
      class Dt {
        constructor(t, e) {
          ((this.animation = void 0),
            ...
            (this.hover = {}),
            (this.hoverBackgroundColor = (t, e) => mt(e.backgroundColor)),
            (this.hoverBorderColor = (t, e) => mt(e.borderColor)),
            (this.hoverColor = (t, e) => mt(e.color)),
            (this.indexAxis = "x"),
            (this.interaction = {
              mode: "nearest",
              intersect: !0,
          ...
          function (t) {
            (t.set("animation", {
              ...
              t.set("animations", {
                ...
                numbers: { type: "number", properties: xt },
              }),
          ...
          if (((u = i[h]), null == u || r(u))) {
            if (r(u))
              for (c = 0, d = u.length; c < d; c++)
                ((f = u[c]), null == f || r(f) || (a = Ot(t, n, o, a, f)));
          } else a = Ot(t, n, o, a, u);
        t.restore();
        const g = o.length / 2;
        if (g > i.length) {
      ...
      function Kt(t) {
        return qt(t, { top: "y", right: "x", bottom: "y", left: "x" });
      }
      function Gt(t) {
        ...
        for (n = 0, o = t.length; n < o; ++n)
          if (
            ...
            void 0 !== a &&
              ...
              void 0 !== i && r(a) && ((a = a[i % a.length]), (l = !1)),
              void 0 !== a))
          )
            return (s && !l && (s.cacheable = !1), a);
      }
      function te(t, e) {
          ...
          get: (i, s) =>
            ae(i, s, () =>
              (function (t, e, i, s) {
                let n;
                for (const o of e)
                  if (((n = ue(ne(o, t), i)), void 0 !== n))
                    return oe(t, n) ? ce(i, s, t, n) : n;
              })(s, e, t, i),
            ),
      ...
      function se(t, e = { scriptable: !0, indexable: !0 }) {
        const {
      ...
      function ce(t, e, i, s) {
        ...
        return (
          null !== c &&
          (void 0 === o || o === i || ((c = de(h, a, o, c, s)), null !== c)) &&
          ee(Array.from(h), [""], n, o, () =>
            (function (t, e, i) {
      ...
      function ge(t, e, i, s) {
        ...
        let r, l, h, c;
        for (r = 0, l = s; r < l; ++r)
          ((h = r + i), (c = e[h]), (a[r] = { r: n.parse(w(c, o), h) }));
        return a;
      }
            ...
            for (i = 0, s = t.length; i < s; ++i)
              ((a = o),
                ...
                o &&
                  ((n = t[i]),
                  a &&
                    ((n.cp1x = ye(n.cp1x, e.left, e.right)),
                    (n.cp1y = ye(n.cp1y, e.top, e.bottom))),
                  r &&
                    ((n.cp2x = ye(n.cp2x, e.left, e.right)),
                    (n.cp2y = ye(n.cp2y, e.top, e.bottom)))));
          })(t, i);
      }
      function Me() {
      ...
      function Ae(t, e, i, s) {
            ...
            if (void 0 === e || void 0 === i) {
              ...
              if (o) {
                ...
                ((e = t.width - l.width - r.width),
                  ...
                  (s = ke(a.maxWidth, o, "clientWidth")),
                  (n = ke(a.maxHeight, o, "clientHeight")));
        ...
        ((h = Math.max(0, h - o.width)),
          ...
          (h = Oe(Math.min(h, a, l.maxWidth))),
          (c = Oe(Math.min(c, r, l.maxHeight))),
          h && !c && (c = Oe(h / 2)));
        return (
          (void 0 !== e || void 0 !== i) &&
            s &&
            l.height &&
            c > l.height &&
            ((c = l.height), (h = Oe(Math.floor(c * s)))),
          { width: h, height: c }
        );
      }
      function Te(t, e, i) {
      ...
      function We(t) {
        return "angle" === t
          ? { between: K, compare: X, normalize: q }
          : { between: J, compare: (t, e) => t - e, normalize: (t) => t };
      }
      function Ne({ start: t, end: e, count: i, loop: s, style: n }) {
        return {
          start: t % i,
          end: e % i,
          loop: s && (e - t + 1) % i == 0,
      ...
      function He(t, e, i) {
        ...
        const { property: s, start: n, end: o } = i,
          a = e.length,
          { compare: r, between: l, normalize: h } = We(s),
          {
            start: c,
            end: d,
            loop: u,
            ...
            m.skip ||
              ...
              p !== x &&
                ...
                null !== _ &&
                  v() &&
                  (g.push(
                    Ne({ start: _, end: t, loop: u, count: a, style: f }),
                  ),
                  (_ = null)),
                (i = t),
                (x = p))));
        return (
          null !== _ &&
            g.push(Ne({ start: _, end: d, loop: u, count: a, style: f })),
          g
        );
      }
      function je(t, e) {
        ...
        update(t, e, i) {
          if (this._active) {
            ...
            ((this._start = i),
              ...
              (this._total += n),
              (this._loop = !!t.loop),
              (this._to = Zt([t.to, e, s, t.from])),
              (this._from = Zt([t.from, s, e])));
          }
        }
        cancel() {
          this._active &&
      ...
      function ri(t, e) {
        ...
        for (let t = 0; t < d; ++t) {
          const i = e[t],
            { [l]: o, [h]: d } = i;
          ((u = (i._stacks || (i._stacks = {}))[h] = oi(n, c, o)),
            (u[r] = d),
      ...
      class ui {
        ...
        buildOrUpdateElements(t) {
          ...
          ((e._stacked = ni(e.vScale, e)),
            e.stack !== i.stack && ((s = !0), hi(e), (e.stack = i.stack)),
            this._resyncElements(t),
            (s || n !== e._stacked) &&
              (ri(this, e._parsed), (e._stacked = ni(e.vScale, e))));
        }
        configure() {
        ...
        parse(t, e) {
          ...
          if (!1 === this._parsing)
            ...
            for (h = 0; h < e; ++h)
              ((i._parsed[h + t] = c = d[h]), u && (n() && (u = !1), (f = c)));
            i._sorted = u;
          }
          o && ri(this, d);
        }
        ...
        parseObjectData(t, e, i, s) {
          ...
          for (h = 0, c = s; h < c; ++h)
            ((d = h + i),
              (u = e[d]),
              (l[h] = { x: n.parse(w(u, a), d), y: o.parse(w(u, r), d) }));
          return l;
        }
        getParsed(t) {
        ...
        updateRangeFromParsed(t, e, i, s) {
          ...
          (s && a && ((s.values = a), (o = si(s, n, this._cachedMeta.index))),
        ...
        getMinMax(t, e) {
          const i = this._cachedMeta,
            ...
            r = ((t, e, i) =>
              t &&
              !e.hidden &&
              e._stacked && { keys: ii(i, !0), values: null })(
              e,
              i,
              this.chart,
            ),
          ...
          for (
            u = 0;
            u < o && (g() || (this.updateRangeFromParsed(l, t, f, r), !n));
            ++u
          );
          if (n)
            for (u = o - 1; u >= 0; --u)
        ...
        _resolveElementOptions(t, e = "default", i) {
          ...
          return (
            f.$shared && ((f.$shared = r), (n[o] = Object.freeze(di(f, r)))),
            f
          );
        }
      ...
      function fi(t) {
        ...
        const l = () => {
          32767 !== o &&
            -32768 !== o &&
            (S(a) && (r = Math.min(r, Math.abs(o - a) || r)), (a = o));
        };
            ...
            { circumference: d, rotation: f } = this._getRotationExtents(),
            {
              ...
              if (e < O) {
                const r = t,
                  ...
                  u = Math.sin(l),
                  f = (t, e, s) =>
                    K(t, r, l, !0) ? 1 : Math.max(e, e * i, s, s * i),
                  g = (t, e, s) =>
                    K(t, r, l, !0) ? -1 : Math.min(e, e * i, s, s * i),
                  p = f(0, h, d),
                  m = f(E, c, u),
                  x = g(C, h, d),
                  b = g(C + E, c, u);
        ...
        BarController: class extends ui {
          ...
          parseObjectData(t, e, i, s) {
            ...
            for (d = i, u = i + s; d < u; ++d)
              ((g = e[d]),
                (f = {}),
                (f[n.axis] = n.parse(w(g, l), d)),
                c.push(gi(w(g, h), f, o, d)));
            return c;
          }
          updateRangeFromParsed(t, e, i, s) {
            ...
            for (let f = e; f < e + i; f++) {
              const e = this.getParsed(f),
                ...
                m = {
                  ...
                  base: i.base,
                  enableBorderRadius:
                    !p || mi(e._custom) || o === p._top || o === p._bottom,
                  x: h ? i.head : g.center,
                  y: h ? g.center : i.head,
            ...
            for (let i = 0; i < _; ++i) {
              ...
              ((_.skip = isNaN(w) || isNaN(k) || M),
                ...
                d &&
                  (_.options =
                    c ||
                    this.resolveDataElementOptions(i, g.active ? "active" : s)),
                x || this.updateElement(g, i, _, s),
                (y = v));
            }
          }
          getMaxOverflow() {
      ...
      var Ei = {
        ...
        modes: {
          ...
          point: (t, e, i, s) =>
            Oi(t, Ce(e, t), i.axis || "xy", s, i.includeInvisible || !1),
          nearest(t, e, i, s) {
            const n = Ce(e, t),
              o = i.axis || "xy",
              a = i.includeInvisible || !1;
      ...
      function ji(t, e, i, s) {
        ...
        for (o = 0, a = t.length, h = 0; o < a; ++o) {
          ((r = t[o]),
            (l = r.box),
            l.update(r.width || e.w, r.height || e.h, Hi(r.horizontal, e)));
          const { same: a, other: d } = Ni(e, i, r, s);
      ...
      var Yi = {
        ...
        update(t, e, i, s) {
          ...
          (ji(r.fullSize, f, d, p),
            ...
            Ui(r.leftAndTop, f, d, p),
            (f.x += f.w),
            (f.y += f.h),
            Ui(r.rightAndBottom, f, d, p),
            (t.chartArea = {
              left: f.left,
              top: f.top,
              right: f.left + f.w,
      ...
      class hs extends Xi {
        ...
        removeEventListener(t, e) {
          const i = t.$proxies || (t.$proxies = {}),
            s = i[e];
          if (!s) return;
          ((({ attach: rs, detach: rs, resize: rs })[e] || Zi)(t, e, s),
            (i[e] = void 0));
        }
        getDevicePixelRatio() {
      ...
      function ds(t, e) {
        ...
        if (r > 0) {
          ...
          for (us(e, c, d, a(s) ? 0 : l - s, l), t = 0, i = r - 1; t < i; t++)
            us(e, c, d, o[t], o[t + 1]);
      ...
      class ys extends cs {
        ...
        getUserBounds() {
          ...
          return (
            ...
            (s = c(s, Number.NEGATIVE_INFINITY)),
            { min: c(t, i), max: c(e, s), minDefined: h(t), maxDefined: h(e) }
          );
        }
        getMinMax(t) {
          let e,
        ...
        update(t, e, i) {
          ...
          (this._convertTicksToLabels(r ? ps(this.ticks, a) : this.ticks),
            this.configure(),
        ...
        generateTickLabels(t) {
          ...
          let i, s, n;
          for (i = 0, s = t.length; i < s; i++)
            ((n = t[i]), (n.label = f(e.callback, [n.value, i, t], this)));
        }
        ...
        calculateLabelRotation() {
          ...
          ((o = t.offset ? this.maxWidth / i : u / (i - 1)),
            c + 6 > o &&
              ...
              (l = j(
                Math.min(
                  Math.asin(G((h.highest.height + 6) / o, -1, 1)),
                  Math.asin(G(a / r, -1, 1)) - Math.asin(G(d / r, -1, 1)),
                ),
              )),
        ...
        getPixelForDecimal(t) {
          ...
          return G(
            this._alignToPixels ? Tt(this.chart, e, 0) : e,
            -32768,
            32767,
          );
        }
          ...
          if (t >= 0 && t < e.length) {
            ...
            return (
              ...
              (i.$context = (function (t, e, i) {
                return te(t, { tick: i, index: e, type: "tick" });
              })(this.getContext(), t, i))
            );
          }
          return (
            this.$context ||
            (this.$context = te(this.chart.getContext(), {
              scale: this,
              type: "scale",
            }))
          );
        ...
        _computeGridLineItems(t) {
          ...
          if ("top" === o)
            ...
            if ("center" === o) b = x((t.top + t.bottom) / 2 + 0.5);
            else if (l(o)) {
        ...
        _computeLabelItems(t) {
          ...
          for (b = 0, _ = a.length; b < _; ++b) {
            ...
            ((S = this.getPixelForTick(b) + n.labelOffset),
        ...
        drawBorder() {
          ...
          let l, h, c, d;
          (this.isHorizontal()
            ? ((l = Tt(t, this.left, o) - o / 2),
              (h = Tt(t, this.right, a) + a / 2),
              (c = d = r))
            : ((c = Tt(t, this.top, o) - o / 2),
              (d = Tt(t, this.bottom, a) + a / 2),
              (l = h = r)),
            e.save(),
            (e.lineWidth = n.width),
        ...
        drawTitle() {
          ...
          "bottom" === e || "center" === e || l(e)
            ? ((h += o.bottom),
              r(i.text) && (h += n.lineHeight * (i.text.length - 1)))
            : (h += o.top);
          const {
            titleX: c,
            titleY: d,
            ...
            if (t.isHorizontal()) {
              if (((f = rt(s, o, r)), l(i))) {
                ...
                g =
                  "center" === i ? (c.bottom + c.top) / 2 + m - e : fs(t, i, e);
              u = r - o;
            } else {
              if (l(i)) {
                const t = Object.keys(i)[0],
                ...
                f =
                  "center" === i ? (c.left + c.right) / 2 - x + e : fs(t, i, e);
      ...
      class vs {
        ...
        unregister(t) {
          ...
          (i in e && delete e[i],
            s &&
              i in Ct[s] &&
              (delete Ct[s][i], this.override && delete wt[i]));
        }
      }
      class Ms {
        constructor() {
          ((this.controllers = new vs(ui, "datasets", !0)),
            (this.elements = new vs(cs, "elements")),
            (this.plugins = new vs(Object, "plugins")),
            (this.scales = new vs(ys, "scales")),
            ...
            ? (function (t, { plugins: e, localIds: i }, s, n) {
                ...
                for (const r of e) {
                  ...
                  null !== l &&
                    o.push({
                      plugin: r,
                      options: Ps(t.config, { plugin: r, local: i[e] }, l, a),
                    });
                }
                return o;
              })(t, n, s, e)
      ...
      function Ps(t, { plugin: e, local: i }, s, n) {
        ...
        return (
          Object.keys(s).forEach((e) => {
            ...
            const r = As(
              ...
              c = i.scales || {};
            o[e] = y(Object.create(null), [{ axis: r }, a, c[r], c[h]]);
          }),
      ...
      class Bs {
        ...
        getOptionScopes(t, e, i) {
          ...
          const r = new Set();
          e.forEach((e) => {
            (t && (r.add(t), e.forEach((e) => Vs(r, t, e))),
              e.forEach((t) => Vs(r, s, t)),
              e.forEach((t) => Vs(r, wt[n] || {}, t)),
              e.forEach((t) => Vs(r, Ct, t)),
              e.forEach((t) => Vs(r, kt, t)));
          });
        ...
        chartOptionScopes() {
          ...
          return [t, wt[e] || {}, Ct.datasets[e] || {}, { type: e }, Ct, kt];
        }
        resolveNamedOptions(t, e, i, s = [""]) {
          const n = { $shared: !0 },
            { resolver: o, subPrefixes: a } = Ws(this._resolverCache, t, s);
          let l = o;
          if (
            (function (t, e) {
              const { isScriptable: i, isIndexable: s } = se(t);
              for (const n of e) {
                const e = i(n),
                  o = s(n),
                  a = (o || e) && t[n];
        ...
        createResolver(t, e, i = [""], s) {
          const { resolver: n } = Ws(this._resolverCache, t, i);
      ...
      const Ns = (t) =>
        l(t) && Object.getOwnPropertyNames(t).some((e) => P(t[e]));
      const Hs = ["top", "bottom", "left", "right", "chartArea"];
      function js(t, e) {
        return (
          "top" === t || "bottom" === t || (-1 === Hs.indexOf(t) && "x" === e)
        );
      }
      function $s(t, e) {
        return function (i, s) {
      ...
      class Js {
        ...
        constructor(t, e) {
          ...
          ((this.id = o()),
            ...
            r &&
              l &&
              (Ge.listen(this, "complete", Us),
              Ge.listen(this, "progress", Ys),
              this._initialize(),
        ...
        _initialize() {
          return (
            ...
            this.options.responsive
              ? this.resize()
              : Te(this, this.options.devicePixelRatio),
            this.bindEvents(),
          ...
          (e &&
            ...
            g(n, (e) => {
              const n = e.options,
                ...
                r = d(n.type, e.dtype);
              ((void 0 !== n.position &&
                js(n.position, a) === js(e.dposition)) ||
        ...
        buildOrUpdateControllers() {
          ...
          for (
            ...
            if (
              ...
              (n.type = o),
              (n.indexAxis = s.indexAxis || Ds(o, this.options)),
              (n.order = s.order || 0),
              (n.index = i),
              (n.label = "" + s.label),
              ...
              const e = ws.getController(o),
                { datasetElementType: s, dataElementType: a } = Ct.datasets[o];
              (Object.assign(e, {
        ...
        _updateDatasets(t) {
          if (
            ...
            for (let e = 0, i = this.data.datasets.length; e < i; ++e)
              this._updateDataset(e, P(t) ? t({ datasetIndex: e }) : t);
        ...
        getContext() {
          return (
            this.$context ||
            (this.$context = te(null, { chart: this, type: "chart" }))
          );
        }
        ...
        _handleEvent(t, e, i) {
          ...
          i &&
            ((this._lastEvent = null),
            f(n.onHover, [t, a, this], this),
            r && f(n.onClick, [t, a, this], this));
          const h = !p(a, s);
          return (
      ...
      function Zs(t, e, i, s) {
        const n = qt(t.options.borderRadius, [
          "outerStart",
          "outerEnd",
          "innerStart",
          "innerEnd",
      ...
      function rn(t, e, i, s) {
        const { points: n, options: o } = e,
          { count: a, start: r, loop: l, ilen: h } = an(n, i, s),
          c = (function (t) {
            return t.stepped
              ? Vt
      ...
      function ln(t, e, i, s) {
        const n = e.points,
          { count: o, start: a, ilen: r } = an(n, i, s),
      ...
      class un extends cs {
        ...
        interpolate(t, e) {
          const i = this.options,
            s = t[e],
            n = this.points,
            o = je(this, { property: e, start: s, end: s });
          if (!o.length) return;
          const a = [],
            r = (function (t) {
              return t.stepped
      ...
      function xn(t, e, i, s) {
        const n = null === e,
          ...
          a = t && !(n && o) && gn(t, s);
        return (
          a && (n || J(e, a.left, a.right)) && (o || J(i, a.top, a.bottom))
        );
      }
      function bn(t, e) {
      ...
      var yn = Object.freeze({
        ...
        PointElement: class extends cs {
          ...
          draw(t, e) {
            ...
            this.skip ||
              i.radius < 0.1 ||
              !It(this, e, this.size(i) / 2) ||
              ((t.strokeStyle = i.borderColor),
              (t.lineWidth = i.borderWidth),
              (t.fillStyle = i.backgroundColor),
              Et(t, i, this.x, this.y));
          }
          getRange() {
            const t = this.options || {};
        ...
        beforeLayout(t, e, i) {
          ...
          const {
            ...
            a =
              ...
              (o && Pn(o)) ||
              "rgba(0,0,0,0.1)" !== Ct.borderColor ||
              "rgba(0,0,0,0.1)" !== Ct.backgroundColor;
          var r;
        ...
        beforeElementsUpdate: (t, e, i) => {
          ...
          t.data.datasets.forEach((e, n) => {
            ...
            let { start: d, count: u } = (function (t, e) {
              ...
              return (
                l && (n = G(Z(e, o.axis, a).lo, 0, i - 1)),
                (s = h ? G(Z(e, o.axis, r).hi + 1, n, i) - n : i - n),
                { start: n, count: s }
              );
            })(l, h);
      ...
      function Vn(t, e, i) {
        ...
        for (let n = 0; n < i.length; n++) {
          const o = i[n],
            { first: a, last: r, point: l } = Bn(o, e, "x");
          if (!(!l || (a && r)))
            if (a) s.unshift(l);
              ...
              for (const e of h) {
                ...
                for (const t of r)
                  a.push({
                    source: t,
                    target: e,
                    start: { [i]: En(l, s, "start", Math.max) },
                    end: { [i]: En(l, s, "end", Math.min) },
                  });
              }
            }
            return a;
      ...
      class Gn extends cs {
        ...
        fit() {
          ...
          const i = t.labels,
            ...
            { boxWidth: a, itemHeight: r } = Kn(i, n);
          let l, h;
          ((e.font = s.string),
            this.isHorizontal()
        ...
        _draw() {
          const { options: t, columnSizes: e, lineWidths: i, ctx: s } = this,
            { align: n, labels: o } = t,
            a = Ct.color,
            r = Fe(t.rtl, this.left, this.width),
            l = Qt(o.font),
            { padding: h } = o,
            c = l.size,
            u = c / 2;
          ...
          (this.drawTitle(),
            ...
            (s.lineWidth = 0.5),
            (s.font = l.string));
          const { boxWidth: g, boxHeight: p, itemHeight: m } = Kn(o, c),
            x = this.isHorizontal(),
            ...
            (r.setWidth(this.width),
              x
                ? v > 0 &&
                  ...
                  ((P = f.y += _),
                  f.line++,
                  (S = f.x = rt(n, this.left + h, this.right - i[f.line])))
                : v > 0 &&
                  P + _ > this.bottom &&
                  ((S = f.x = S + e[f.line].width + h),
                  f.line++,
                  (P = f.y =
                    rt(n, this.top + b + h, this.bottom - e[f.line].height))));
            if (
              ((function (t, e, i) {
                ...
                if (
                  ((s.fillStyle = d(i.fillStyle, a)),
                  (s.lineCap = d(i.lineCap, "butt")),
                  (s.lineDashOffset = d(i.lineDashOffset, 0)),
                  (s.lineJoin = d(i.lineJoin, "miter")),
                  (s.lineWidth = n),
                  (s.strokeStyle = d(i.strokeStyle, a)),
                  s.setLineDash(d(i.lineDash, [])),
                  o.usePointStyle)
                ) {
                  const a = {
              ...
              (S = ((t, e, i, s) =>
                t === (s ? "left" : "right")
                  ...
                  : "center" === t
                    ? (e + i) / 2
                    : e)(w, S + g + u, x ? S + k : this.right, t.rtl)),
              (function (t, e, i) {
        ...
        _getLegendItemAt(t, e) {
          ...
          if (J(t, this.left, this.right) && J(e, this.top, this.bottom))
            for (n = this.legendHitBoxes, i = 0; i < n.length; ++i)
              if (
                ((s = n[i]),
                J(t, s.left, s.left + s.width) && J(e, s.top, s.top + s.height))
              )
            ...
            const o = this._hoveredItem,
              a =
                ...
                null !== (s = o) &&
                  ...
                  s.index === n.index);
            (o && !a && f(e.onLeave, [t, o, this], this),
              (this._hoveredItem = i),
              i && !a && f(e.onHover, [t, i, this], this));
      ...
      var Qn = {
        ...
        _element: Gn,
        start(t, e, i) {
          const s = (t.legend = new Gn({ ctx: t.ctx, options: i, chart: t }));
      ...
      class Zn extends cs {
        ...
        _drawArgs(t) {
          ...
          return (
            this.isHorizontal()
              ? ((l = rt(a, i, n)), (h = e + t), (r = n - i))
              : ("left" === o.position
                  ? ((l = i + t), (h = rt(a, s, e)), (c = -0.5 * C))
                  : ((l = n - t), (h = rt(a, e, s)), (c = 0.5 * C)),
                (r = s - e)),
      ...
      var to = {
        ...
        start(t, e, i) {
          !(function (t, e) {
            const i = new Zn({ ctx: t.ctx, options: e, chart: t });
      ...
      var io = {
        id: "subtitle",
        start(t, e, i) {
          const s = new Zn({ ctx: t.ctx, options: i, chart: t });
      ...
      function ro(t, e) {
        ...
        return (
          ...
          g(t.title, y),
          (i.font = l.string),
          g(t.beforeBody.concat(t.afterBody), y),
      ...
      function ho(t, e, i) {
        ...
        return { xAlign: i.xAlign || e.xAlign || lo(t, e, i, s), yAlign: s };
      }
      function co(t, e, i, s) {
        ...
        return (
          ...
          { x: G(g, 0, s.width - e.width), y: G(p, 0, s.height - e.height) }
        );
      }
      function uo(t, e, i) {
      ...
      class xo extends cs {
        ...
        getContext() {
          return (
            ...
            (this.$context =
              ...
              te(t, { tooltip: e, tooltipItems: i, type: "tooltip" })))
          );
          var t, e, i;
        }
        getTitle(t, e) {
          const { callbacks: i } = e,
            s = mo(i, "beforeTitle", this, t),
            n = mo(i, "title", this, t),
            o = mo(i, "afterTitle", this, t);
          let a = [];
          return (
            (a = no(a, oo(s))),
            (a = no(a, oo(n))),
          ...
          return (
            g(t, (t) => {
              const e = { before: [], lines: [], after: [] },
                n = go(i, t);
              (no(e.before, oo(mo(n, "beforeLabel", this, t))),
                no(e.lines, mo(n, "label", this, t)),
                no(e.after, oo(mo(n, "afterLabel", this, t))),
                s.push(e));
            }),
            s
          );
        ...
        getFooter(t, e) {
          const { callbacks: i } = e,
            s = mo(i, "beforeFooter", this, t),
            n = mo(i, "footer", this, t),
            o = mo(i, "afterFooter", this, t);
          let a = [];
          return (
            (a = no(a, oo(s))),
            (a = no(a, oo(n))),
        ...
        _createItems(t) {
          ...
          return (
            ...
            g(l, (e) => {
              ...
              (s.push(mo(i, "labelColor", this, e)),
                n.push(mo(i, "labelPointStyle", this, e)),
                o.push(mo(i, "labelTextColor", this, e)));
            }),
            (this.labelColors = s),
        ...
        getCaretPosition(t, e, i) {
          const { xAlign: s, yAlign: n } = this,
            ...
            { topLeft: r, topRight: l, bottomLeft: h, bottomRight: c } = Gt(a),
            { x: d, y: u } = t,
            { width: f, height: g } = e;
          let p, m, x, b, _, y;
          return (
        ...
        _drawColorBox(t, e, i, s, n) {
          ...
          if (n.usePointStyle) {
            ...
            Object.values(a).some((t) => 0 !== t)
              ? (t.beginPath(),
                (t.fillStyle = n.multiKeyBackground),
                jt(t, { x: e, y: g, w: h, h: r, radius: a }),
                t.fill(),
                t.stroke(),
                (t.fillStyle = o.backgroundColor),
                t.beginPath(),
                jt(t, { x: i, y: g + 1, w: h - 2, h: r - 2, radius: a }),
                t.fill())
              : ((t.fillStyle = n.multiKeyBackground),
                t.fillRect(e, g, h, r),
        ...
        draw(t) {
          ...
          e.enabled &&
            ...
            Ve(t, e.textDirection),
            (n.y += o.top),
            this.drawTitle(n, t, e),
            this.drawBody(n, t, e),
            this.drawFooter(n, t, e),
            Be(t, e.textDirection),
            t.restore());
        }
        getActiveElements() {
          return this._active || [];
      ...
      function Mo(t, e) {
        ...
        ((k = Math.ceil(m / S) - Math.floor(p / S)),
          k > g && (S = B((k * S) / g / f) * f),
          a(l) || ((v = Math.pow(10, l)), (S = Math.ceil(S * v) / v)),
          "ticks" === s
        ...
        for (
          ...
          (u && M !== o
            ? (i.push({ value: o }),
              M < o && D++,
              V(Math.round((M + D * S) * v) / v, o, wo(o, y, t)) && D++)
            : M < o && D++);
          D < k;
          ++D
        ) {
        ...
        return (
          b && u && w !== r
            ? i.length && V(i[i.length - 1].value, r, wo(r, y, t))
      ...
      class So extends ko {
        static id = "linear";
        static defaults = { ticks: { callback: Mt.formatters.numeric } };
        determineDataLimits() {
      ...
      function Ao(t, { min: e, max: i }) {
        ...
        for (; f < i; )
          (s.push({ value: f, major: Co(f), significand: u }),
            u >= 10 ? (u = u < 15 ? 15 : 20) : u++,
            u >= 20 && (o++, (u = 2), (a = o >= 0 ? 1 : a)),
            (f = Math.round((l + d + u * Math.pow(10, o)) * a) / a));
        const g = c(t.max, f);
        return (s.push({ value: g, major: Co(g), significand: u }), s);
      }
      class To extends ys {
        ...
        determineDataLimits() {
          ...
          ((this.min = h(t) ? Math.max(0, t) : null),
            ...
            this._zero &&
              ...
              !h(this._userMin) &&
              (this.min =
                t === Do(this.min, 0) ? Do(this.min, -1) : Do(this.min, 0)),
            this.handleTickRangeOptions());
        }
        handleTickRangeOptions() {
          ...
          const n = (e) => (i = t ? i : e),
            o = (t) => (s = e ? s : t);
          (i === s && (i <= 0 ? (n(1), o(10)) : (n(Do(i, -1)), o(Do(s, 1)))),
            i <= 0 && n(Do(s, -1)),
            s <= 0 && o(Do(i, 1)),
            (this.min = i),
            (this.max = s));
        ...
        buildTicks() {
          const t = this.options,
            e = Ao({ min: this._userMin, max: this._userMax }, this);
          return (
            "ticks" === t.bounds && N(e, this, "value"),
            t.reverse
        ...
        getLabelForValue(t) {
          return void 0 === t
            ? "0"
            : yt(t, this.chart.options.locale, this.options.ticks.format);
        }
        configure() {
          const t = this.min;
          (super.configure(),
      ...
      function Eo(t, e, i) {
        return (
          (i = r(i) ? i : [i]),
          { w: At(t, e.string, i), h: i.length * e.lineHeight }
        );
      }
        ...
        (t.setCenterPoint(e.l - i.l, i.r - e.r, e.t - i.t, i.b - e.b),
          (t._pointLabelItems = (function (t, e, i) {
            const s = [],
              ...
              l = { extra: Lo(o) / 2, additionalAngle: a ? C / n : 0 };
            let h;
            for (let o = 0; o < n; o++) {
              ((l.padding = i[o]), (l.size = e[o]));
              const n = Fo(t, o, l);
              (s.push(n),
                "auto" === r && ((n.visible = Vo(n, h)), n.visible && (h = n)));
            }
            return s;
          })(t, s, n)));
      }
      ...
      class No extends ko {
        ...
        static defaults = {
          ...
          grid: { circular: !1 },
          startAngle: 0,
          ticks: { showLabelBackdrop: !0, callback: Mt.formatters.numeric },
          pointLabels: {
        ...
        getPointLabelContext(t) {
          ...
          if (t >= 0 && t < e.length) {
            ...
            return (function (t, e, i) {
              return te(t, { label: i, index: e, type: "pointLabel" });
            })(this.getContext(), t, i);
          }
        }
      ...
      function Uo(t, e) {
        ...
        return (
          ...
          h(r) || (r = "string" == typeof s ? i.parse(r, s) : i.parse(r)),
          null === r
            ? null
            : (n &&
                (r =
      ...
      class Ko extends ys {
        ...
        determineDataLimits() {
          ...
          ((o && a) ||
            ...
            (n = h(n) && !isNaN(n) ? n : +e.endOf(Date.now(), i) + 1),
        ...
        buildTicks() {
          ...
          return (
            (this._unit =
              e.unit ||
              (i.autoSkip
                ? Yo(e.minUnit, this.min, this.max, this._getLabelCapacity(n))
                : (function (t, e, i, s, n) {
                    for (let o = jo.length - 1; o >= jo.indexOf(i); o--) {
                      const i = jo[o];
                      if (Ho[i].common && t._adapter.diff(n, s, i) >= e - 1)
                        return i;
                    }
        ...
        _generate() {
          ...
          return (
            (c !== i && "ticks" !== s.bounds && 1 !== u) || Xo(h, c, g),
            Object.keys(h)
              .sort($o)
              .map((t) => +t)
          );
      ...
      var Jo = Object.freeze({
        ...
        CategoryScale: class extends ys {
          static id = "category";
          static defaults = { ticks: { callback: vo } };
          constructor(t) {
            (super(t),
              (this._startValue = void 0),
              (this._valueRange = 0),
          ...
          parse(t, e) {
            ...
            return ((t, e) => (null === t ? null : G(Math.round(t), 0, e)))(
              (e =
                isFinite(e) && i[e] === t
                  ? e
                  : yo(i, t, d(e, t), this._addedLabels)),
              i.length - 1,
            );
          }
          determineDataLimits() {
        ...
        TimeSeriesScale: class extends Ko {
          ...
          initOffsets() {
            ...
            ((this._minPos = Go(e, this.min)),
              (this._tableRange = Go(e, this.max) - this._minPos),
              super.initOffsets(t));
          }
          buildLookupTable(t) {
