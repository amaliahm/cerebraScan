/**
 * med parent stories: 4-column vertical infinite reel.
...
function createReviewCard(r, openModal) {
  ...
  medImg.className = "review-reel-card__med";
  medImg.alt = r.medAlt;
  medImg.width = 400;
  medImg.height = 280;
  medImg.decoding = "async";
  medImg.loading = "lazy";
  bindImg(medImg, r.medImageKey);
  ...
  article.append(medImg, headline, quote, stars, foot);
...
function fillReviewModal(dialog, r) {
  ...
  med.className = "doctor-modal__photo";
  med.alt = r.medAlt;
  med.decoding = "async";
  bindImg(med, r.medImageKey);
  imgCol.appendChild(med);
